...
<template>
  ...
  >
    ...
    <NDivider title-placement="left"> 辅助信息 </NDivider>
    ...
    <NFormItem label="关于我" path="aboutMe">
      <NInput
        ...
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.aboutMe"
      />
    </NFormItem>
    <NDivider title-placement="left"> 偏好信息 </NDivider>
    <NFormItem label="收藏性类别" path="collections">
      <NInput
        type="textarea"
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.collections"
      />
    </NFormItem>
    <NFormItem label="我是这里的" path="infoHere">
      <NInput
        ...
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.infoHere"
      />
    </NFormItem>
    <NFormItem label="最喜欢的理想性伴侣" path="ideal">
      <NInput
        ...
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.ideal"
      />
    </NFormItem>
    <NFormItem label="我的敏感/好球区" path="erogenic">
      <NInput
        ...
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.erogenic"
      />
    </NFormItem>
    <NFormItem label="最喜欢" path="favorite">
      <NInput
        ...
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.favorite"
      />
    </NFormItem>
    <NFormItem label="最讨厌" path="hate">
      <NInput
        ...
        clearable
        :maxlength="200"
        v-model:value="jmStore.useredit.value.hate"
      />
    </NFormItem>
    <div class="mt-2">
      <NButton type="primary" @click="submit" :loading="isSubmitting" :disabled="isSubmitting"
        >提交信息更新</NButton
      >
    </div>
  </NForm>
